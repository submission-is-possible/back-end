...
urlpatterns = [
    ...
    path('get_reviewers/paper/<int:paper_id>/conference/<int:conference_id>', views.get_all_reviewers_assigned_to_paper_for_conference, name='get_reviewers_for_paper'),
]